...
public interface SuperusuarioService {
    ...
    Superusuario alterarSuperusuario(String matricula, Superusuario superusuario);
    void excluirSuperusuario(String matricula);
    ...
    Superusuario alterarSuperusuario(String matricula, Superusuario superusuario, String emailSuperusuarioAutenticado);
